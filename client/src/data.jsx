...
const API = {
  ...
  listMcpTokens:  ()      => apiFetch('/api/mcp-tokens'),
  createMcpToken: (label) => apiFetch('/api/mcp-tokens', { method: 'POST', body: { label } }),
  revokeMcpToken: (id)    => apiFetch(`/api/mcp-tokens/${id}`, { method: 'DELETE' }),
  ...
  // Taşınma: dosya gövdesi zaten JSON nesnesi, apiFetch dizeye çeviriyor.
  exportWorkspaceUrl: (format, lang) => `/api/workspaces/me/export?format=${format}&lang=${lang}`,
  importWorkspace: (paket) => apiFetch('/api/workspaces/me/import', { method: 'POST', body: paket }),
};
window.API = API;
...
window.APP_I18N = {
  tr: {
    ...
    set_ws_export_title:'Dışa aktar',
    set_ws_export_desc:'Projeler, kolonlar, kartlar, alt görevler ve yorumlar. JSON taşınma ve yedek için, CSV Excel için, Markdown okumak için. Ekler ve süre kayıtları dahil değil; her indirme denetim kaydına yazılır.',
    set_ws_export_json_title:'Taşınma ve yedek için; geri yüklenebilir',
    set_ws_export_csv_title:'Excel için; kart başına bir satır',
    set_ws_export_md_title:'Okunabilir belge; Notion gibi',
    set_ws_import_title:'İçe aktar',
    set_ws_import_desc:'StoaBoard JSON dosyası. Her seferinde yeni proje açılır, var olan projelere karışmaz. Atananlar bu alanın üyeleri arasında eşlenir; eşleşmeyenler kartta not olarak düşer.',
    set_ws_import_btn:'JSON yükle',
    set_ws_import_busy:'Yükleniyor…',
    set_ws_import_bad_json:'Dosya okunamadı: geçerli JSON değil',
    set_ws_import_done:'İçe aktarıldı: {projects} proje, {tasks} kart, {subtasks} alt görev, {comments} yorum.',
    set_ws_import_unmatched:'Üye olmayan atananlar: {list}',
    ...
    set_mcp_nav:'Claude bağlantısı', set_mcp_title:'Claude bağlantısı',
    set_mcp_desc:'Claude’un panoyu senin adına okuyup güncelleyebilmesi için kişisel anahtar. Anahtar senin izinlerinle çalışır; senin göremediğini göremez.',
    set_mcp_url:'Bağlantı adresi', set_mcp_copy:'Kopyala', set_mcp_copied:'Kopyalandı.',
    set_mcp_copy_failed:'Kopyalanamadı; metni elle seçip kopyala.',
    set_mcp_steps_title:'Claude’da kurulum',
    set_mcp_step1:'Claude → Ayarlar → Bağlayıcılar → Özel bağlayıcı ekle',
    set_mcp_step2:'Adres alanına yukarıdaki bağlantıyı yapıştır',
    set_mcp_step3:'Kimlik doğrulamada “No sign-in” seç',
    set_mcp_step4:'İstek başlığı ekle: x-auth-token = anahtarın',
    set_mcp_step5:'“Add” ile kaydet; “Connect” düğmesine basma',
    set_mcp_warn:'Bağlayıcıyı “disconnect” edersen geri bağlanamaz; kaldırıp yeniden ekle. Parolanı değiştirdiğinde bütün anahtarların iptal edilir.',
    set_mcp_label_ph:'Anahtar adı, ör. İş bilgisayarı', set_mcp_create:'Anahtar oluştur', set_mcp_creating:'Oluşturuluyor…',
    set_mcp_new_title:'Yeni anahtarın',
    set_mcp_new_warn:'Bu anahtar bir daha gösterilmeyecek. Şimdi kopyala ve Claude’daki bağlayıcıya yapıştır.',
    set_mcp_new_done:'Kopyaladım, kapat',
    set_mcp_list_title:'Etkin anahtarlar', set_mcp_none:'Henüz anahtarın yok.', set_mcp_loading:'Yükleniyor…',
    set_mcp_created:'Oluşturuldu', set_mcp_last_used:'Son kullanım', set_mcp_never_used:'Hiç kullanılmadı',
    set_mcp_revoke:'İptal et', set_mcp_revoke_confirm:'Bu anahtarı kullanan bağlayıcı hemen çalışmaz hâle gelir.',
    set_mcp_cancel:'Vazgeç', set_mcp_revoked:'Anahtar iptal edildi.',
    set_mcp_limit_reached:'Sınıra ulaştın; yeni anahtar için birini iptal et.',
    ...
    board_timeline_wide_only:'Çizelge geniş ekranda',
    board_timeline_wide_only_desc:'Çizelge, işleri bir zaman ekseni üzerinde gösteriyor ve bunun için genişliğe ihtiyacı var. Telefonu yatay çevirdiğinde ya da bilgisayarda açılır.',
    board_timeline_wide_only_alt:'Bu ekranda Liste, Pano ve Tablo görünümleri var.',
    board_filter:'Filtrele', board_search_placeholder:'Görev ara — numara için #193',
    board_id_not_here:'#{n} bu projede yok — tüm projelerde aramak için Ctrl+K',
    ...
    notif_err_action:'Bildirim işlemi kaydedilemedi',
    notif_err_load:'Bildirimler yüklenemedi',
    notif_dismiss:'Kaldır', notif_err_no_target:'Bu bildirimin gideceği yer açılamadı.',
    ...
    notes_remote_changed:'Bu notu başka biri değiştirdi. Sizin yazdıklarınız henüz kaydedilmedi.',
    notes_remote_take:'Onun sürümünü al',
    notes_remote_keep:'Benimkini kaydet',
    ...
    drawer_comment_placeholder:'Yorum yaz… @ ile bahset', drawer_comment_delete:'Yorumu sil',
    ...
    doc_kind_p:'Paragraf', doc_kind_h2:'Başlık', doc_kind_h3:'Alt başlık', doc_kind_quote:'Alıntı', doc_kind_pre:'Kod', doc_kind_callout:'Uyarı kutusu', doc_placeholder:'Yazmaya başla, tür için "/"',
    ...
    chat_write_channel:'#{kanal} kanalına yaz...',
    ...
    chat_channel_first:'#{kanal} kanalına ilk mesajı gönder.',
    ...
    chat_channel_slug_ph:'ornek-kanal', chat_search_in_msgs:'Mesajlarda ara', chat_search_in_msgs_ph:'Mesajlarda ara...', chat_add_reaction:'Reaksiyon ekle', chat_msg_delete_failed:'Mesaj silinemedi: ', chat_pin_after_save:'Mesaj kaydedildikten sonra sabitleyebilirsin.', chat_channels_word:'kanal',
    board_col_attachments:'Ekler', board_col_comments:'Yorumlar', board_col_reactions:'Reaksiyonlar',
    chat_file:'Dosya',
    ...
    notif_column_added:'<em>{who}</em>, <strong>{title}</strong> adında yeni bir kolon açtı.',
    ...
    rep_stamp_source:'Kaynak',
    rep_stamp_source_val:'StoaBoard — kolon geçiş kaydı ve süre kaydı',
    rep_stamp_source_audit:'StoaBoard — denetim kaydı',
    rep_foot_person:'Süre = iş günlüğüne girilen dakikalar. Hareket = kartın kolon değiştirme sayısı. Tamamlandı = bitiş kolonuna geçiş.',
    rep_foot_period_bars:'Her çubuk, aralıkta o kolona yapılan geçiş sayısıdır. Aynı kart ileri geri taşındıysa birden çok kez sayılır.',
    rep_foot_period_done:'Tamamlanma = kartın bitiş kolonuna geçtiği an. Geçen gün = açılıştan tamamlanmaya takvim günü. Emek = iş günlüğü toplamı.',
    rep_foot_flow_dwell:'Bekleme = kartın o kolonda geçirdiği süre, kolon geçiş kaydından. Ölçüm = hesaba giren geçiş sayısı; ölçüm azsa ortalama oynaktır.',
    rep_foot_flow_slowest:'Gün = açılıştan tamamlanmaya geçen takvim günü. Bekleme ve üzerinde çalışılan süre bu sayıda ayrışmaz.',
    rep_foot_audit:'Her satır bir denetim olayıdır; IP isteğin geldiği adrestir. Denetim kayıtları silinmez ve çöp kutusundan etkilenmez.',
    rep_person:'Kişi', rep_everyone:'Herkes', rep_project:'Proje', rep_all_projects:'Tüm projeler', rep_col_project:'Proje',
    ...
    rep_status_done:'Tamamlandı', rep_status_ongoing:'Açık',
    ...
    rep_act_ws_export:'Çalışma alanı dışa aktarıldı',
    err_export_forbidden:'Çalışma alanını dışa aktarma yetkiniz yok',
    err_import_forbidden:'Çalışma alanına içe aktarma yetkiniz yok',
    rep_act_ws_import:'Çalışma alanına içe aktarıldı',
    ...
    rep_act_mcp_attachment:'Karta dosya eklendi — MCP',
    ...
    rep_act_mcp_ws_left:'Bu alandan çıkıldı — MCP',
    rep_act_mcp_message:'Mesaj gönderildi — MCP',
    rep_act_mcp_auth_failed:'Geçersiz MCP anahtarı denendi',
    rep_act_mcp_refused:'Kural reddi — MCP',
    rep_act_mcp_token_created:'MCP anahtarı oluşturuldu', rep_act_mcp_token_revoked:'MCP anahtarı iptal edildi',
    ...
    err_mcp_token_rate_limited:'Çok fazla anahtar oluşturuldu; bir süre sonra yeniden dene.',
    err_mcp_token_limit:'Etkin anahtar sınırına ulaştın; yeni anahtar için birini iptal et.',
    err_mcp_token_not_found:'Anahtar bulunamadı.',
    ...
    err_mcp_bad_base64:'Dosya gövdesi çözülemedi (base64 bozuk).',
    err_mcp_rule_done_column:'Yapay zekâ kartı Tamamlandı kolonuna alamaz; bitirme kararı insanın.',
    err_mcp_rule_desc_overwrite:'Yapay zekâ dolu açıklamanın üzerine yazamaz; yalnızca sonuna ekleyebilir.',
    err_mcp_rule_quota:'Yapay zekânın saatlik işlem kotası doldu.',
...
err_action_forbidden:'Bu işlem için yetkiniz yok',
    ...
    err_doc_invalid:'Kart gövdesi geçersiz', err_doc_checklist_retired:'Yapılacaklar artık alt görev olarak saklanıyor; sayfayı yenileyip yeniden deneyin.',
    ...
    err_file_too_large:'Dosya 10 MB sınırını aşıyor',
    ...
    err_logo_too_large:"Logo 5 MB'dan büyük olamaz",
    err_unsupported_file_type:'Desteklenmeyen dosya türü',
    err_upload_rate_limited:'Çok fazla dosya yüklediniz; biraz sonra tekrar deneyin',
...
err_channel_name_taken:'Bu isimde bir kanal zaten var',
    ...
    app_err_task_missing:'Görev bulunamadı — silinmiş ya da erişiminiz yok.',
    app_err_project_switch:'Proje açılamadı, eski proje yerinde kaldı.',
    board_tl_undated:'Tarihi belirsiz',
    chat_back:'Geri',
    chat_exit:'Sohbetten çık',
  ...
  en: {
    ...
    set_ws_export_title:'Export',
    set_ws_export_desc:'Projects, columns, cards, subtasks and comments. JSON for migration and backup, CSV for Excel, Markdown for reading. Attachments and time logs are not included; every download is written to the audit log.',
    set_ws_export_json_title:'For migration and backup; can be restored',
    set_ws_export_csv_title:'For Excel; one row per card',
    set_ws_export_md_title:'Readable document, like Notion',
    set_ws_import_title:'Import',
    set_ws_import_desc:'A StoaBoard JSON file. Always creates new projects; never merges into existing ones. Assignees are matched among this workspace\'s members; unmatched ones are noted on the card.',
    set_ws_import_btn:'Upload JSON',
    set_ws_import_busy:'Uploading…',
    set_ws_import_bad_json:'Could not read the file: not valid JSON',
    set_ws_import_done:'Imported: {projects} projects, {tasks} cards, {subtasks} subtasks, {comments} comments.',
    set_ws_import_unmatched:'Assignees who are not members: {list}',
    ...
    set_mcp_nav:'Claude connection', set_mcp_title:'Claude connection',
    set_mcp_desc:'A personal key that lets Claude read and update the board on your behalf. It works with your permissions, so it can’t see anything you can’t.',
    set_mcp_url:'Connector URL', set_mcp_copy:'Copy', set_mcp_copied:'Copied.',
    set_mcp_copy_failed:'Couldn’t copy; select the text and copy it manually.',
    set_mcp_steps_title:'Set up in Claude',
    set_mcp_step1:'Claude → Settings → Connectors → Add custom connector',
    set_mcp_step2:'Paste the URL above into the address field',
    set_mcp_step3:'Choose “No sign-in” for authentication',
    set_mcp_step4:'Add a request header: x-auth-token = your key',
    set_mcp_step5:'Save with “Add”; don’t press “Connect”',
    set_mcp_warn:'If you disconnect the connector it can’t reconnect; remove it and add it again. Changing your password revokes all your keys.',
    set_mcp_label_ph:'Key name, e.g. Work laptop', set_mcp_create:'Create key', set_mcp_creating:'Creating…',
    set_mcp_new_title:'Your new key',
    set_mcp_new_warn:'This key won’t be shown again. Copy it now and paste it into the connector in Claude.',
    set_mcp_new_done:'I copied it, close',
    set_mcp_list_title:'Active keys', set_mcp_none:'You don’t have any keys yet.', set_mcp_loading:'Loading…',
    set_mcp_created:'Created', set_mcp_last_used:'Last used', set_mcp_never_used:'Never used',
    set_mcp_revoke:'Revoke', set_mcp_revoke_confirm:'Any connector using this key stops working immediately.',
    set_mcp_cancel:'Cancel', set_mcp_revoked:'Key revoked.',
    set_mcp_limit_reached:'Limit reached; revoke a key to create a new one.',
    ...
    board_timeline_wide_only:'Timeline needs a wider screen',
    board_timeline_wide_only_desc:'The timeline lays work out along a time axis, which needs width. Turn your phone sideways, or open it on a computer.',
    board_timeline_wide_only_alt:'List, Board and Table views work on this screen.',
    board_filter:'Filter', board_search_placeholder:'Search tasks — use #193 for a number',
    board_id_not_here:'#{n} is not in this project — press Ctrl+K to search everywhere',
    ...
    notif_err_action:'Could not save the notification change',
    notif_err_load:'Could not load notifications',
    notif_dismiss:'Dismiss', notif_err_no_target:'Could not open where this notification points.',
    ...
    notes_remote_changed:'Someone else changed this note. Your edits are not saved yet.',
    notes_remote_take:'Take their version',
    notes_remote_keep:'Save mine',
    ...
    drawer_comment_placeholder:'Write a comment… @ to mention', drawer_comment_delete:'Delete comment',
    ...
    doc_kind_p:'Paragraph', doc_kind_h2:'Heading', doc_kind_h3:'Subheading', doc_kind_quote:'Quote', doc_kind_pre:'Code', doc_kind_callout:'Callout', doc_placeholder:'Start writing, "/" for block type',
    ...
    chat_write_channel:'Write to #{kanal}...',
    ...
    chat_channel_first:'Send the first message to #{kanal}.',
    ...
    chat_channel_slug_ph:'example-channel', chat_search_in_msgs:'Search messages', chat_search_in_msgs_ph:'Search messages...', chat_add_reaction:'Add reaction', chat_msg_delete_failed:'Message could not be deleted: ', chat_pin_after_save:'You can pin the message once it is saved.', chat_channels_word:'channels',
    board_col_attachments:'Attachments', board_col_comments:'Comments', board_col_reactions:'Reactions',
    chat_file:'File',
    ...
    notif_column_added:'<em>{who}</em> added a new column: <strong>{title}</strong>',
    ...
    rep_stamp_source:'Source',
    rep_stamp_source_val:'StoaBoard — column transition log and time log',
    rep_stamp_source_audit:'StoaBoard — audit log',
    rep_foot_person:'Duration = minutes entered in the time log. Moves = how many times the card changed column. Done = moved into the done column.',
    rep_foot_period_bars:'Each bar is the number of moves into that column within the range. A card moved back and forth is counted more than once.',
    rep_foot_period_done:'Completed = the moment the card moved into the done column. Days elapsed = calendar days from creation to completion. Effort = total from the time log.',
    rep_foot_flow_dwell:'Wait = time the card spent in that column, from the transition log. Samples = transitions included in the average; few samples make it volatile.',
    rep_foot_flow_slowest:'Days = calendar days from creation to completion. Waiting time and time actually worked are not separated in this number.',
    rep_foot_audit:'Each row is one audit event; IP is the address the request came from. Audit records are never deleted and are unaffected by the trash.',
    rep_person:'Person', rep_everyone:'Everyone', rep_project:'Project', rep_all_projects:'All projects', rep_col_project:'Project',
    ...
    rep_meta_tasks:'tasks', rep_meta_moves:'moves', rep_meta_completions:'completed',
    rep_col_task:'Task', rep_col_duration:'Duration', rep_moves:'Moves', rep_col_status:'Status',
    rep_status_done:'Completed', rep_status_ongoing:'Open',
    ...
    rep_act_ws_export:'Workspace exported',
    err_export_forbidden:'You do not have permission to export this workspace',
    err_import_forbidden:'You do not have permission to import into this workspace',
    rep_act_ws_import:'Imported into workspace',
    ...
    rep_act_mcp_attachment:'Attachment added — MCP',
    ...
    rep_act_mcp_ws_left:'Left this workspace — MCP',
    rep_act_mcp_message:'Message sent — MCP',
    rep_act_mcp_auth_failed:'Invalid MCP key attempted',
    rep_act_mcp_refused:'Rule refusal — MCP',
    rep_act_mcp_token_created:'MCP key created', rep_act_mcp_token_revoked:'MCP key revoked',
    ...
    err_mcp_token_rate_limited:'Too many keys created; try again later.',
    err_mcp_token_limit:'You’ve reached the active key limit; revoke a key to create a new one.',
    err_mcp_token_not_found:'Key not found.',
    ...
    err_mcp_bad_base64:'File body could not be decoded (invalid base64).',
    err_mcp_rule_done_column:'The AI cannot move a card to a Done column; finishing is a human decision.',
    err_mcp_rule_desc_overwrite:'The AI cannot overwrite a non-empty description; it can only append.',
    err_mcp_rule_quota:'The hourly AI action quota is used up.',
...
err_action_forbidden:'You are not allowed to do this',
    ...
    err_doc_invalid:'Card body is invalid', err_doc_checklist_retired:'To-do items are now stored as subtasks; reload the page and try again.',
    ...
    err_file_too_large:'File exceeds the 10 MB limit',
    ...
    err_logo_too_large:'Logo is larger than 5 MB',
    err_unsupported_file_type:'Unsupported file type',
    err_upload_rate_limited:'Too many uploads; please try again shortly',
...
err_channel_name_taken:'A channel with this name already exists',
    ...
    app_err_task_missing:'Task not found — it was deleted or you do not have access.',
    app_err_project_switch:'Could not open the project; the previous one is still active.',
