...
window.APP_I18N = {
  tr: {
    ...
    set_ws_export_desc:'Projeler, kolonlar, kartlar, alt görevler ve yorumlar tek JSON dosyasında. Ekler ve süre kayıtları dahil değil. İndirme denetim kaydına yazılır.',
    set_ws_export_btn:'JSON indir',
...
err_channel_name_taken:'Bu isimde bir kanal zaten var',
  ...
  en: {
    ...
    set_ws_export_desc:'Projects, columns, cards, subtasks and comments in one JSON file. Attachments and time logs are not included. The download is written to the audit log.',
    set_ws_export_btn:'Download JSON',
